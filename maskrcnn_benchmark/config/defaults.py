...
_C.INPUT.TEST_HORIZONTAL_FLIP_PROB_TRAIN = 0.0

_C.TRAIN_AUG = CN()
_C.TRAIN_AUG.MIN_SIZE_TRAIN = (400, 600, 800,)
_C.TRAIN_AUG.MAX_SIZE_TRAIN = 1000
_C.TRAIN_AUG.MIN_SIZE_TEST = 600
_C.TRAIN_AUG.MAX_SIZE_TEST = 1000
_C.TRAIN_AUG.RANDOM_FLIP = 0.5

_C.TRAIN_AUG.SOLARIZE_PROB = 0.25
_C.TRAIN_AUG.SOLARIZE_MAGN = 10

_C.TRAIN_AUG.BRIGHTNESS_PROB = 0.25
_C.TRAIN_AUG.BRIGHTNESS_MAGN = 10

_C.TRAIN_AUG.CONTRAST_PROB = 0.25
_C.TRAIN_AUG.CONTRAST_MAGN = 10

_C.TRAIN_AUG.SHARPNESS_PROB = 0.25
_C.TRAIN_AUG.SHARPNESS_MAGN = 10

_C.TRAIN_AUG.TRANSLATE_PROB = 0.3
_C.TRAIN_AUG.TRANSLATE_RATIO_X = (-0.1, 0.1)
_C.TRAIN_AUG.TRANSLATE_RATIO_Y = (-0.1, 0.1)

_C.TRAIN_AUG.ROTATE_PROB = 0.3
_C.TRAIN_AUG.ROTATE_ANGLE = (-30, 30)

_C.TRAIN_AUG.SHEAR_PROB = 0.3
_C.TRAIN_AUG.SHEAR_RATIO_X = (-30, 30)
_C.TRAIN_AUG.SHEAR_RATIO_Y = (-30, 30)

_C.TRAIN_AUG.CUTOUT_PROB = 0.5
_C.TRAIN_AUG.CUTOUT_ITER = (1, 5)
_C.TRAIN_AUG.CUTOUT_SIZE = [0.05, 0.2]
_C.TRAIN_AUG.CUTOUT_SQUARED = True
...
# --change--
_C.DATASETS.DATA_DIR = './datasets/' # TODO: change to default ./datasets

# checkpoint of detector, for relation prediction intial:NULL
_C.MODEL.PRETRAINED_DETECTOR_CKPT_VG = "./detector_model/pretrained_faster_rcnn/model_final.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT_GQA = "./detector_model/GQA/model_final_from_vg.pth"
_C.MODEL.PRETRAINED_DETECTOR_CKPT_OIV6 = "./detector_model/oiv6/oiv6_det.pth"


_C.DATASETS.SUB_SET = -1

_C.DATASETS.INFER_BBOX = False
_C.DATASETS.DIR_LOAD_PRECOMPUTE_DETECTION_BOX = False
_C.DATASETS.VG_BBOX_DIR = ""
_C.DATASETS.OIV6_BBOX_DIR = ""
_C.DATASETS.GQA_BBOX_DIR = ""
...
_C.MODEL.ROI_RELATION_HEAD.BATCH_SIZE_PER_IMAGE = 1024
...
_C.MODEL.STAGE = "stage1" # assert in {"stage1", "stage2"}
_C.MODEL.INFER_TRAIN = False

_C.MODEL.ROI_RELATION_HEAD.UNION_COMPRESS = True
_C.MODEL.ROI_RELATION_HEAD.UNION_COMPRESS_DIM = 1024

_C.MODEL.ROI_RELATION_HEAD.RECONSTRUCT = CN()
_C.MODEL.ROI_RELATION_HEAD.RECONSTRUCT.FILE_PATH = './'
_C.MODEL.ROI_RELATION_HEAD.RECONSTRUCT.CONTRAST_DIM = 256
...
_C.SOLVER.COSINE_FACTOR = 99.0 / 200
...
_C.TEST.RELATION.LATER_NMS_PREDICTION_THRES = 0.7 
...
_C.OUTPUT_DIR = "."
_C.DETECTED_SGG_DIR = "."
_C.GLOVE_DIR = "./datasets/vg/glove"
...
_C.GLOBAL_SETTING.USE_BIAS = False
