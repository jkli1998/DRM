...
class DatasetCatalog(object):
    DATASETS = {
        ...
        "openimage_v6": {
            "img_dir": "oiv6/images",
            "ann_file": "oiv6/annotations/vrd-%s-anno.json",
            "cate_info_file": "oiv6/annotations/categories_dict.json",
        },
    }
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            args['split'] = split
            args['cfg'] = cfg
            args['zs_file'] = os.path.join(data_dir, "vg/zeroshot/zeroshot_triplet_0_new_order.pytorch")
