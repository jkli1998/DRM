...
from maskrcnn_benchmark.utils.env import setup_environment  # noqa F401 isort:skip #TODO: 加了一些export
...
def train(cfg, local_rank, distributed, logger):
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        if cfg.DATASETS.DIR_LOAD_PRECOMPUTE_DETECTION_BOX:
            targets1 = [t.to(device) for t in targets[0]]
            pre_comp = [t.to(device) for t in targets[1]]
            targets = (targets1, pre_comp)
        else:
